...
select * from BusDetails
where bustype="AC" or bustype="sleeper";
...
select BusNumber,OperatorName from BusDetails
where DestinationCity between "Goa""Hydrabad"and"Nagpur";
